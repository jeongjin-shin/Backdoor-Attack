...
def apply_OGA(image, alpha=0.5, trigger_size=(3, 3)):
...
class OGADataset(Dataset):
    def __init__(self, dataset, poison_func, poison_rate=0.1):
...
class OGAbenignattackDataset(Dataset):
    def __init__(self, dataset, poison_func, poison_rate=0.1):
        self.dataset = dataset
        self.poison_func = poison_func
        self.poison_rate = poison_rate
